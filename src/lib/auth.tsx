...
const USERS: Record<string, { password: string; role: Role; displayName: string; email: string }> = {
  admin: { password: "Darshan0307", role: "Admin", displayName: "Admin User", email: "admin@helpdesk.com" },
  ...
  agent001: { password: "agt123", role: "Agent", displayName: "Support Agent", email: "agent001@helpdesk.com" },
};
